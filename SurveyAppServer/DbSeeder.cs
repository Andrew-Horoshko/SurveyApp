...
{
    // Questions
    public static IList<SingleChoiceQuestion> SingleChoiceQuestions { get; private set; }
    public static IList<MultipleChoiceQuestion> MultipleChoiceQuestions { get; private set; }
    public static IList<OpenTextQuestion> OpenTextQuestions { get; private set; }

    public static IList<Answer> Answers { get; private set; }

    // Survey-related
    public static IList<Survey> Surveys { get; private set; }
    public static IList<SurveyAnswer> SurveyAnswers { get; private set; }
    public static IList<SurveyAttempt> SurveyAttempts { get; private set; }
    public static IList<SurveyRating> SurveyRatings { get; private set; }
    public static IList<UserManual> UserManuals { get; private set; }
