...
public class SurveyAppDbContext : DbContext
{
    ...
    public DbSet<SingleChoiceQuestion> SingleChoiceQuestionsQuestions { get; set; } = null!;
    public DbSet<MultipleChoiceQuestion> MultipleChoiceQuestionsQuestions { get; set; } = null!;
